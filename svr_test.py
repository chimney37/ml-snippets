...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--load',
                        ...
                        action='store_true',
                        help='setting the\
                        flag loads a saved model instead of training the model.First time runs should not use this flag',
                        required=False)
...
if(vars(args)["flag_exists"]):
    ...
    kernel_confidence_sorted = sorted(kernel_confidence.items(), key=lambda x: x[1], reverse=True)
